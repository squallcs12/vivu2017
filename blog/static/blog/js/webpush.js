  ...
  subBtn.addEventListener('click',
    function(e) {
      ...
      // If service worker not supported, show warning to the message box
        ...
        messageBox.textContent = 'Your browser doesn\'t support this feature. Please try Chrome.';
      }
    }
  );
    ...
    .then(
      function(response) {
        ...
        if ((response.status == 201) && (statusType == 'subscribe')) {
          ...
          subBtn.textContent = 'You\'ll be received notification when this website have new post';
          ...
          getSubscription(registration)
            .then(
              function(subscription) {
                ...
                .then(
                  function(response) {
                    subBtn.textContent = 'Notify me when have new post';
                    isPushEnabled = false;
                    subBtn.disabled = false;
                  }
                )
